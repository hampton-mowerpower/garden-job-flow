...
-- Fix JB2025-0028 customer link (corrected - only non-generated columns)
-- First, ensure Stephen Swirgoski customer exists
...
SELECT 
  ...
  ARRAY['customer_id'],
  COALESCE((SELECT id FROM auth.users WHERE email = 'fonzren@gmail.com' LIMIT 1)::text, 'admin'),
